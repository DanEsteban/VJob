                ...
                <div class="row">
                    <div class="col-md-5">
                        <div class="input-group">
                            ...
                            <input name="customer" onchange="filterInvoice(this.value);" class="form-control form-control-sm" type="text" list="customerList" placeholder="Choose a Customer" style="font-size: 20px" value="{{$current_customer->company_name}}">
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="input-group">
                                    ...
                                    <input onchange="changeTerm(this.value);" name="term" class="form-control form-control-sm" type="text" list="termList" placeholder="Choose a Term" value="{{$invoice->id_term}}" required>
                                    <datalist id="termList">
                                        @foreach ($terms as $term)
                                            <option value="{{$term->name}}" <?php if($term->id == $invoice->id_term) echo 'selected'?>></option>
                                        @endforeach
                                    </datalist>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="input-group">
                                    ...
                                    <input name="reference" class="form-control form-control-sm" type="text">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        @if ($invoice->card_number)
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="input-group">
                                            ...
                                            <input class="form-control form-control-sm mt-1 cc-number" name="ccn" id="ccn" type="tel" inputmode="numeric" pattern="[0-9\s]" maxlength="19" placeholder="XXXX XXXX XXXX XXXX">
                                        </div>
                                    </div>
                                </div>
                                <br>
                                <div class="row">
                                    <div class="col">
                                        <div class="input-group">
                                            ...
                                            <input class="form-control form-control-sm cc-expires" name="cce" id="cce" type="tel" maxlength="5" placeholder="MM / YY">
                                        </div>                             
                                    </div>
                                </div>
                            </div>
            ...
            <div class="card body">
                ...
                <table class="table table-sm">
                    ...
                    <tbody id="tb-facturas">
                        @php
                            $amount =  PaymentsDetails::where('invoice', $invoice->number)->sum('amount');
                            $due_amount = $invoice->total - $amount;
                        @endphp
                        <tr>
                            <td></td>
                            <td>{{$invoice->date}}</td>
                            <td><input id="invoice" name="invoice[]" class="form-control form-control-sm" type="text" value="{{$invoice->number}}" style="width:50%" readonly></td>
                            <td id="original_amount">{{$invoice->total}}</td>
                            <td id="due_amount">{{number_format($due_amount, 2)}}</td>
                            <td><input id="payment" name="payment[]" onkeyup="changeAmount(this);" class="form-control form-control-sm" type="text" style="width:50%" value=""></td>
                        </tr>
                    </tbody>
                </table>
                <hr>
        ...
        <div class="row">
            ...
            <div class="col">          
                <div class="card">
                    ...
                    <div class="card-body">
                        <textarea class="form-control form-control-sm" name="memo" id="memo" cols="30" rows="4" style="resize: none"></textarea>
                    </div>
                </div>
            </div>
        </div>
