...
@endif
    ...
    <br>
    <form action="/payments" method="POST" id="pay-form">
        @csrf
        <div class="card">
            <div class="card-body">
                <div class="row">
        ...
        <div class="card">
            <div class="card body">
                ...
                <div class="row bg-dark">
                    ...
                    <div id="origin" class="col">0</div>
                    <div id="due" class="col">0</div>
                    <div id="pay" class="col">0</div>
                </div>
            </div>
        </div>
        <br>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="input-group">
                                ...
                                <input id="due_total" class="form-control form-control-sm" type="text" style="border: none" value="0.00" readonly>
                            </div>
                        </div>
                        <br>
                        <div class="row">
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    data.forEach(element => {
                        ...
                        if (element['balance']) {
                            let result = parseFloat(element['amount']) - parseFloat(element['balance']);
