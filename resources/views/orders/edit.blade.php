            ...
            <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-7">
                                <div class="input-group">
                                    ...
                                    <input id="select_customer" name="select_customer" onchange="newCustomer();" type="text" autocomplete="off" class="form-control form-control-sm" width="300px" list="customersList" value="{{$order->id_customer}}">
                            ...
                            <div class="col-md-4">
                                <div class="input-group">
                                    ...
                                    <input name="date" type="date" class="form-control form-control-sm" value="{{$order->date}}" width="300px">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">              
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            <textarea id="billto" name="billto" class="form-control form-control-sm mt-2" cols="30" rows="5" style="width:170px; height: 117px; resize: none">{{$order->billto}}</textarea>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="row">
                        ...
                        <div class="input-group">
                            @if ($shipto->count() > 0)
                                <textarea id="shipto" name="shipto" class="form-control form-control-sm" style="width:279px;  resize: none;" cols="33" rows="5" tabindex="11">{{$shipto[0]->address."\n".$shipto[0]->company."\n".$shipto[0]->city."\n".$shipto[0]->postal."\n".$shipto[0]->state}}</textarea>
                            @else
                    ...
                    <div class="col">
                        <div class="row">
                            <div class="input-group">
                                ...
                                <input id="phone" name="phone" type="text" class="form-control form-control-sm" value="{{$order->phone}}">
                            </div>
                        </div>
                        <br>
                        <div class="row">
                            <div class="input-group">
                                ...
                                <input id="email" name="email" type="text" class="form-control form-control-sm" value="{{$order->email}}">
                            </div>
                        </div>
                        <br>
                        <div class="row">
                            <div class="input-group">
                                ...
                                <Select id="select_warehouse" name="select_warehouse" class="form-select form-select-sm" style="width:170px;" aria-label=".form-select-sm" tabindex="13">
                                    ...
                                    <option value="{{$wh->id}}" <?php echo ($wh->id == $order->id_warehouse) ? ' selected="selected"' : '';?>>{{$wh->wh_name}}</option>
                                    @endforeach
                                </Select>
                            </div>
                        </div>
                    ...
                    <tbody id="tb_items">
                        ...
                        @foreach ($order_items as $oitem)
                            <tr id="tr_items">
                                ...
                                <td>
                                    <input onchange="changeItem2(this, {{json_encode($items)}}, {{json_encode($types)}})" id="items" name="items[]" type="text" autocomplete="off" class="form-control form-control-sm" width="300px" list="itemsList" value="{{$code}}">
                                ...
                                <td>
                                    <input id="description" name="description[]" autocomplete="off" onchange="changeDescription(this, {{json_encode($items)}}, {{json_encode($types)}})" type="text" class="form-control form-control-sm" list="itemDesList" value="{{$description}}">
                                ...
                                <td><input  autocomplete="off" onkeyup="changeQty(this);" id="qty" name="qty[]" type="text" class="form-control form-control-sm" value="{{$oitem->qty}}" required></td>
                                ...
                                <td><input  autocomplete="off" onkeyup="changePrice(this);" id="price" name="price[]" type="text" class="form-control form-control-sm" value="{{$oitem->price}}"></td>
                        ...
                        <div class="col-md-4">
                            <div class="row" id="Porcent">
                                <div class="input-group">
                                    ...
                                    &nbsp;&nbsp;&nbsp;
                                    <input oninput="clearTimeout(window.typingTimer); window.typingTimer = setTimeout(function() { porcentage(); }, 900);" id="porcentaje" name="porcentaje" type="text" class="form-control form-control-sm" value="{{$order->porcentage}}">
                                </div>
                            </div>
                            <br>
                            <div class="input-group">
                    ...
                    <div class="nav justify-content-end">
                        <div class="col-md-5">
                            <div class="input-group">
                                ...
                                @if ($order->taxes)
                                    <input style="font-size: 100%; text-align: right; font-weight: bold" class="form-control form-control-sm" type="text" name="order_subtotal" id="order_subtotal" style="text-align:right;" value="${{$order->total - $order->taxes}}" readonly>
                                @else
                                    <input style="font-size: 100%; text-align: right; font-weight: bold" class="form-control form-control-sm" type="text" name="order_subtotal" id="order_subtotal" style="text-align:right;" value="${{$order->total}}" readonly>
                                @endif
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="nav justify-content-end">
                        <div class="col-md-5">
                            <div class="input-group">
                                ...
                                @if ($order->taxes)
                                    <input style="font-size: 100%; text-align: right; font-weight: bold" type="text" class="form-control form-control-sm" name="order_tax" value="${{$order->taxes}}" readonly>     
                                @else
                                    <input style="font-size: 100%; text-align: right; font-weight: bold" type="text" class="form-control form-control-sm" name="order_tax" value="$0.00" readonly>     
                                @endif                         
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="nav justify-content-end">
                        <div class="col-md-5">
                            <div class="input-group">
                                ...
                                <input style="font-size: 40px; text-align: right; font-weight: bold" class="form-control form-control-sm" type="text" name="order_total" id="order_total" style="text-align:right;" value="${{$order->total}}" readonly>
                            </div>
                        </div>
                    </div>
                </div>
