...
@section('content')
    ...
    @endphp
    <br>
    <form action="/invoices/{{$invoice->id}}" enctype="multipart/form-data" method="POST" id="doc_form">
        @csrf
        @method('PUT')
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-3">
                    <div class="input-group mt-4">
                        ...
                        <input name="number" type="text" class="form-control" style="border: 0; font-size: 25px" value="{{$invoice->number}}">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-7">
                                <div class="input-group">
                                    ...
                                    @endphp
                                    <label class="col-sm-2 col-form-label form-control-sm">Customer:</label>
                                    <input id="select_customer" name="select_customer" onchange="newCustomer();" type="text" autocomplete="off" class="form-control form-control-sm" width="300px" list="customersList" value="{{$customer}}">
                            ...
                            <div class="col-md-4">
                                <div class="input-group">
                                    ...
                                    <input name="date" type="date" class="form-control form-control-sm" value="{{date('Y-m-d', strtotime($invoice->date))}}" width="300px">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">              
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            <textarea id="billto" name="billto" class="form-control form-control-sm mt-2" cols="30" rows="5" style="width:170px; height: 117px; resize: none">{{$invoice->billto}}</textarea>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="row">
                            ...
                            <div class="col">
                                <select id="select_shipto" onchange="newShipTo();" name="select_shipto[]" class="form-select form-select-sm" style="width:170px;" aria-label=".form-select-sm" tabindex="13">
                                    ...
                                    @foreach ($shipto as $ship)
                                        <option value="{{$ship->id}}" <?php echo ($ship->id ==  $invoice->id_shipto) ? ' selected="selected"' : '';?>>{{$ship->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="col">
                        <div class="row">
                            <div class="input-group">
                                ...
                                <input id="phone" name="phone" type="text" class="form-control form-control-sm" value="{{$invoice->phone}}">
                            </div>
                        </div>
                        <br>
                        <div class="row">
                            <div class="input-group">
                                ...
                                <input id="email" name="email" type="text" class="form-control form-control-sm" value="{{$invoice->email}}">
                            </div>
                        </div>
                        <br>
                        <div class="row">
                            <div class="input-group">
                                ...
                                <Select id="select_warehouse" name="select_warehouse" class="form-select form-select-sm" style="width:170px;" aria-label=".form-select-sm" tabindex="13">
                                    ...
                                    <option value="{{$invoice->id_warehouse}}" <?php echo (old('select_warehouse')) ? ' selected="selected"' : '';?>>{{$wh->wh_name}}</option>
                                    @endforeach
                                </Select>
                            </div>
                        </div>
            ...
            <div class="card-body">
                <table id="dTable" class="table table-sm" style="width: 100%">
                    ...
                    <tbody id="tb_items">
                        @php
                            $index = 0;
                        @endphp
                        @foreach ($invoice_items as $oitem)
                            <tr id="tr_items">
                                @php
                                $code = Products::where('id', $oitem->id_item)->value('item_name');
                                    $stock= Products::where('id', $oitem->id_item)->value('qty');
                                    $description = Products::where('id', $oitem->id_item)->value('sales_description');
                                    $has_process = Products::where('id', $oitem->id_item)->value('id_process');
                                    $conditions = ProcessPhases::select('process_conditions.*', 'process_stages.has_inventory_received', 'process_stages.has_attachment_customer')->join('process_stages', 'process_stages.id_phase', '=', 'process_phases.id')
                                                ->join('process_conditions', 'process_conditions.id_stage', '=', 'process_stages.id')->get()->toArray();                       
                                @endphp
                                ...
                                <td>
                                    <input autocomplete="off" onchange="changeItem(this, {{json_encode($items)}}, {{json_encode($types)}})" onblur="calcular();" id="items" name="items[]" type="text" autocomplete="off" class="form-control form-control-sm" width="300px" list="itemsList" value="{{$code}}">
                                ...
                                <td>
                                    <input autocomplete="off" onchange="changeDescription(this, {{json_encode($items)}}, {{json_encode($types)}})" id="description" name="description[]" type="text" autocomplete="off" class="form-control form-control-sm" width="300px" list="itemDesList" value="{{$description}}">
                                ...
                                <td hidden><input id="existencia" name="existencia[]" type="text" class="form-control form-control-sm" value="{{$stock}}"></td>
                                <td><input onkeyup="changeQty(this);" id="qty" name="qty[]" type="text" class="form-control form-control-sm" value="{{$oitem->qty}}" required></td>
                                <td><input id="unit" name="unit[]" type="text" class="form-control form-control-sm" value="{{$oitem->unit}}" readonly></td>
                                <td hidden><input id="price_real" name="price_real[]" type="text" class="form-control form-control-sm" value="{{$oitem->price}}"></td>
                                <td><input onkeyup="changePrice(this);" id="price" name="price[]" type="text" class="form-control form-control-sm" value="{{$oitem->price}}"></td>
                                <td><input id="amt" type="text" class="form-control form-control-sm" value="{{$oitem->qty * $oitem->price}}" readonly></td>
                            </tr>
                                @php
                                    $index++;
                                @endphp
                    ...
                    <div class="nav justify-content-end">
                        <div class="col-md-5">
                            <div class="input-group">
                                ...
                                <div class="col-sm-8">
                                    @if ($invoice->taxes)
                                        <input style="font-size: 100%; text-align: right; font-weight: bold" class="form-control form-control-sm" type="text" name="order_subtotal" id="order_subtotal" style="text-align:right;" value="${{$invoice->total - $invoice->taxes}}" readonly>
                                    @else
                                        <input style="font-size: 100%; text-align: right; font-weight: bold" class="form-control form-control-sm" type="text" name="order_subtotal" id="order_subtotal" style="text-align:right;" value="${{$invoice->total}}" readonly>
                                    @endif
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-sm-5">
                                    <select onchange="taxes(this);" name="select_tax" id="select_tax" class="form-select form-select-sm">
                                        ...
                                        @foreach ($taxes as $tax)
                                            <option value="{{$tax->id}}" <?php echo ($tax->id ==  $invoice->id_taxes) ? ' selected="selected"' : '';?>>{{$tax->description}}-{{$tax->percentage}} %</option>
                                        @endforeach
                                    </select>
                                </div>
                                <input style="font-size: 100%; text-align: right; font-weight: bold" type="text" class="form-control form-control-sm" id="order_tax" name="order_tax" value="@if($invoice->taxes)${{$invoice->taxes}}@else $0.00 @endif" readonly>     
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="nav justify-content-end">
                        <div class="col-md-5">
                            <div class="input-group">
                                ...
                                <div class="col-sm-8">
                                    <input style="font-size: 40px; text-align: right; font-weight: bold" class="form-control form-control-sm" type="text" name="order_total" id="order_total" value="${{$invoice->total}}" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="nav justify-content-end">
                        ...
                        <div class="col-md-4" id="posicion">
                            <div class="row" id="Porcent">
                                <div class="input-group">
                                    <label for="" class="col-sm-4 col-form-label form-control-sm">Porcent:</label>
                                    <input oninput="clearTimeout(window.typingTimer); window.typingTimer = setTimeout(function() { porcentage(); }, 900);" id="porcentaje" name="porcentaje" type="text" class="form-control form-control-sm" value="{{$invoice->porcentage}}">
                                </div>
                            </div>
                            <br>
                            <div class="input-group">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                                    ...
                                    <div class="col-md-5 mt-2">
                                        ...
                                        <div class="row-md-4">
                                            <div class="container" style="border: 1px solid gray">
                                                <br>
                                                <input class="form-control form-control-sm" id="street_billto" name="street_billto" type="text" placeholder="Street Number And Name Or P.O Box">
                                                <hr>
                                                <input class="form-control form-control-sm" id="company_billto" name="company_billto" type="text" placeholder="Specify Company, APT, Suite, Unit">
                                                <hr>
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <input class="form-control form-control-sm" id="city_billto" name="city_billto" type="text" placeholder="City">
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <input class="form-control form-control-sm" id="postal_billto" name="postal_billto" type="text" placeholder="Postal Code">
                                                    </div>
                                                </div>
                                                <hr>
                                                <input class="form-control form-control-sm" id="state_billto" name="state_billto" type="text" placeholder="State">
                                                <br>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="modal-footer">
                    <button type="subtmit" onclick="validate();" class="btn btn-primary">Save</button>
                    <button type="button" onclick="cancelar();" class="btn btn-danger" data-bs-dismiss="modal">Cancelar</button>
                </div>
            </div>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="modal-footer">
                    <button type="button" onclick="saveShipTo();" class="btn btn-primary" data-bs-dismiss="modal">Save</button>
                    <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Cancelar</button>
                </div>
            </div>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="modal-footer">
                    <button type="button" onclick="saveShipToModal();" class="btn btn-primary" data-bs-dismiss="modal">Save</button>
                    <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Cancelar</button>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
     ...
     function porcentage(){
        ...
        cells.each(function() {
            ...
            //console.log(currentValueInicial,porcent);
            ...
            if(code){
                $.ajax({
                    ...
                    success : function(any){
                        ...
                        tr.find('#existencia').val(any['qty']);
                        $("#stock").val(any['qty']);
                        ...
                        if (isNaN(porcentage)) {                             
                            ...
                            let price = parseFloat(any['price']);
                            let total = price+(price*porcentage);
                            tr.find('#price').val(total.toFixed(2));
                            tr.find('#amt').val(total.toFixed(2));
                        }
    ...
    function saveCustomer() {
        ...
        let billto_city = $('#createCustomer #city_billto').val();
        let billto_postal = $('#createCustomer #postal_billto').val();
        let billto_state = $('#createCustomer #state_billto').val();
