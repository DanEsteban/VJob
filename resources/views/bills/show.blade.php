...
@section('title', 'Mostar Factura Compra')
                ...
                <div class="row">
                    ...
                    <div id="botones" class="col-md-3">
                        <div class="d-flex justify-content-end">
                            <a href="/bills/create" type="button" class="btn btn-sm btn-outline-primary mr-2">
                ...
                <table id="dTable" class="table table-bordered">
                    ...
                    <tbody>
                        <?php foreach ($baseProductsInv as $item) : ?>
                            <tr>
                                <td>
                                    <input id="items" value="{{$item['id']}}" type="text" autocomplete="off" class="form-control form-control-sm" readonly>
                                </td>
                                <td>
                                    <input id="description" value="{{$item['item_name']}}" type="text" autocomplete="off" class="form-control form-control-sm" readonly>
                                </td>
                                <td><input type="text" onchange="changeQty(this);" id="cantidad" value="{{$item['qty']}}" class="form-control form-control-sm" readonly></td>
                                <td><input type="text" id="pvp0_neto" value="{{number_format($item['price'], 2)}}" class="form-control form-control-sm" readonly></td>  
                                
                                
                                <td><input type="text" id="iva" value="{{$item['iva']}}%" class="form-control form-control-sm" readonly></td>
                                
                                <td><input type="text" id="subtotal" value="{{number_format($item['price']*$item['qty'], 2)}}" class="form-control form-control-sm" readonly></td>
                            </tr>
                        <?php endforeach; ?>    
                    </tbody>
                </table>
...
<script type="text/javascript">
    ...
    function generarNC(num_fact) {
        num_fact = num_fact.toString();
        const numeroFactura = num_fact.padStart(9, "0");
        ...
        Swal.fire({
            title: 'Porque genera N/C?',
            html: `
                <form id="form_swal" action="{{ route('documents.store') }}" method="post">
                    @csrf
                    <input type="text" style="width: 100%;" class="swal-input" value="Anulación de la Factura ${numeroFactura}">
                    <input hidden type="text" name="id_fact" value="${id}">
                </form>
            `,
            showDenyButton: true,
