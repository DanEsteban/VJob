...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col">
                    <input type="text" class="form-control form-control-sm" style="width:600px;" placeholder="Escribir aquí..." value="{{$role->name}}" disabled>
                </div> 
            </div>      
        </div>
    </div>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="acceso" name="acceso[]" value="activo" disabled <?php if($es_permitido) echo "checked"; ?>>
                                </div>
                            </td>
                        </tr>
                    @endforeach
