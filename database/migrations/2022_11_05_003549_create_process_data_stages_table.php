...
class CreateProcessDataStagesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('process_data_stages', function (Blueprint $table) {
            $table->id();
            $table->integer("id_phases");
            $table->string("name");
    ...
    {
        Schema::dropIfExists('process_data_stages');
    }
}
